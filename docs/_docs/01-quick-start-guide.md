...
Minimal Mistakes has been developed as a [Gem-based theme](http://google.com) for easier use, and 100% compatible with GitHub Pages when used as a remote theme.
